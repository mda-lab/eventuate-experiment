 ...
 * @generated
 */
public class DDDRootElementSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DDDRootElementPackage.AGGREGATE_ROOT: {
			...
			case DDDRootElementPackage.ENTITY: {
				Entity entity = (Entity)theEObject;
				T result = caseEntity(entity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DDDRootElementPackage.AGGREGATE: {
				Aggregate aggregate = (Aggregate)theEObject;
				T result = caseAggregate(aggregate);
				if (result == null) result = caseEntity(aggregate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DDDRootElementPackage.IDENTITY: {
				Identity identity = (Identity)theEObject;
				T result = caseIdentity(identity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DDDRootElementPackage.VALUE_OBJECT: {
				ValueObject valueObject = (ValueObject)theEObject;
				T result = caseValueObject(valueObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DDDRootElementPackage.DTO: {
				DTO dto = (DTO)theEObject;
				T result = caseDTO(dto);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DDDRootElementPackage.REPOSITORY: {
				Repository repository = (Repository)theEObject;
				T result = caseRepository(repository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DDDRootElementPackage.BOUNDED_CONTEXT: {
